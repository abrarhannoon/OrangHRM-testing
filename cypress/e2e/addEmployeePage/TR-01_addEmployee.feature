Feature: TR-01_Add employee page
    ...
    Scenario: Verify successful employee creation with valid data
        ...
        And The employee id "12010023"
        And The admin user toggles the Create Login Details checkbox
        And The user name "abrar_user239"
        And The password "StrongPass123"
        And The confirm password "StrongPass123"
        And The admin user clicks on Save button
        Then The employee should be added successfully and redirect to view personal Details page and the employee id "12010023" should be exist
    ...
    Scenario: Verify the "Cancel" button returns to the employee list page
        ...
        Then The admin user should be redirected to the employee list page and the employee id "12099" should not be exist in employees list
